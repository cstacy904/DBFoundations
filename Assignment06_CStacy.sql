...
-- 2026-05-22,CStacy,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_CStacy')
	 Begin 
	  Alter Database [Assignment06DB_CStacy] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_CStacy;
	 End
	Create Database Assignment06DB_CStacy;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_CStacy;
